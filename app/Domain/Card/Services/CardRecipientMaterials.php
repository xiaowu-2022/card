...
final class CardRecipientMaterials
{
    ...
    public function __construct()
    {
        ...
        $this->cipher = new Encrypter(hash_hkdf('sha256', $root, 32, 'card-recipient-materials-encryption-v1'), 'AES-256-GCM');
        $this->hashKey = hash_hkdf('sha256', $root, 32, 'card-recipient-materials-idempotency-v1');
    }
    ...
    {
        return hash_hmac('sha256', json_encode(['card-recipient-v1', $tenantId, $userId, $productId, $canonicalMaterials], JSON_THROW_ON_ERROR), $this->hashKey);
    }
}
