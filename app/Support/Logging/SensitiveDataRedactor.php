...
{
    private const SENSITIVE_KEY_PATTERN = '/^(?:code|code_hash|verification_code|verification_code_hash|identity_number_encrypted|identity_hash|ocr_result|ocr_result_encrypted|document_url|signed_url|front_object_key|back_object_key|withdrawal_address|address_ciphertext|address_hash|(?:.*_)?(?:password(?:_confirmation)?|otp|identity_number|identity_document|api_key|secret|token|pan|cvv|authorization|cookie|set_cookie))$/';
