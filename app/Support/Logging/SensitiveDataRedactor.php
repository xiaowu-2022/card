...
{
    private const SENSITIVE_KEY_PATTERN = '/^(?:.*_)?(?:password(?:_confirmation)?|otp|identity_number|identity_document|api_key|secret|token|pan|cvv|authorization|cookie|set_cookie)$/';
